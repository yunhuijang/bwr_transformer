...
if __name__ == '__main__':
    ...
    work_type_parser.add_argument('--type', type=str, required=True, default='train')
    work_type_parser.add_argument('--config', type=str, required=True, default='qm9')
    work_type_parser.add_argument('--seed', type=str, required=True, default='42')
